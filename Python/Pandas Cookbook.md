...
The [indexing](http://127.0.0.1:54789/pandas/pandas.pydata.org/docs/user_guide/indexing.html#indexing) docs.
...
The [multindexing](http://127.0.0.1:54789/pandas/pandas.pydata.org/docs/user_guide/advanced.html#advanced-hierarchical) docs.
...
The [missing data](http://127.0.0.1:54789/pandas/pandas.pydata.org/docs/user_guide/missing_data.html#missing-data) docs.
...
The [grouping](http://127.0.0.1:54789/pandas/pandas.pydata.org/docs/user_guide/groupby.html#groupby) docs.
...
The [Pivot](http://127.0.0.1:54789/pandas/pandas.pydata.org/docs/user_guide/reshaping.html#reshaping-pivot) docs.
...
The [Resample](http://127.0.0.1:54789/pandas/pandas.pydata.org/docs/user_guide/timeseries.html#timeseries-resampling) docs.
...
Valid frequency arguments to Grouper [Timeseries](http://127.0.0.1:54789/pandas/pandas.pydata.org/docs/user_guide/timeseries.html#timeseries-offset-aliases)
...
The [Join](http://127.0.0.1:54789/pandas/pandas.pydata.org/docs/user_guide/merging.html#merging-join) docs.
...
The [Plotting](http://127.0.0.1:54789/pandas/pandas.pydata.org/docs/user_guide/visualization.html#visualization) docs.
...
![../_images/quartile_boxplot.png](http://127.0.0.1:54789/pandas/pandas.pydata.org/docs/_images/quartile_boxplot.png)
...
The [CSV](http://127.0.0.1:54789/pandas/pandas.pydata.org/docs/user_guide/io.html#io-read-csv-table) docs
...
Finally, this strategy will work with the other `pd.read_*(...)` functions described in the [io docs](http://127.0.0.1:54789/pandas/pandas.pydata.org/docs/user_guide/io.html#io).
...
In [199]: %timeit pd.to_datetime(df.year * 10000 + df.month * 100 + df.day, format='%Y%m%d')
   ...
   .....: 
2.94 ms +- 300 us per loop (mean +- std. dev. of 7 runs, 100 loops each)
1.23 ms +- 4.74 us per loop (mean +- std. dev. of 7 runs, 1,000 loops each)
```
...
The [SQL](http://127.0.0.1:54789/pandas/pandas.pydata.org/docs/user_guide/io.html#io-sql) docs
...
The [Excel](http://127.0.0.1:54789/pandas/pandas.pydata.org/docs/user_guide/io.html#io-excel) docs
...
The [HDFStores](http://127.0.0.1:54789/pandas/pandas.pydata.org/docs/user_guide/io.html#io-hdf5) docs
...
Often it’s useful to obtain the lower (or upper) triangular form of a correlation matrix calculated from [`DataFrame.corr()`](http://127.0.0.1:54789/pandas/pandas.pydata.org/docs/reference/api/pandas.DataFrame.corr.html#pandas.DataFrame.corr). This can be achieved by passing a boolean mask to `where` as follows:
...
The [Timedeltas](http://127.0.0.1:54789/pandas/pandas.pydata.org/docs/user_guide/timedeltas.html#timedeltas-timedeltas) docs.
...
© 2025, pandas via [NumFOCUS, Inc.](https://numfocus.org/) Hosted by [OVHcloud](https://www.ovhcloud.com/).
